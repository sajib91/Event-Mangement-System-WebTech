            ...
            if ($stmtOngoingEvents->rowCount() > 0) {
                while ($event = $stmtOngoingEvents->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    if (!empty($event['event_image'])) {
                        echo '<img src="' . htmlspecialchars($event['event_image'], ENT_QUOTES, 'UTF-8') . '" alt="Event Image" class="img-fluid rounded mb-3" style="max-height: 220px; width: 100%; object-fit: cover;">';
                    }
