<?php
require_once 'PARTS/path-config.php';
...
<!-- Main Content -->
<main class="py-5 flex-grow-1" style="background-color: #1e63ef">
    <div class="container">
        <?php
                ...
                if ($ongoingEventCount > 0) {
                    ...
                    while ($event = $stmtOngoingEvents->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        if (!empty($event['event_image'])) {
                            ...
                            if (strpos($eventImage, '../') === 0) {
                                $eventImage = substr($eventImage, 3);
                            }
                            echo '<div class="mb-3">';
                            echo '<img src="' . htmlspecialchars($eventImage, ENT_QUOTES, 'UTF-8') . '" alt="Event Image" class="img-fluid rounded" style="max-height: 250px; width: 100%; object-fit: cover;">';
                            echo '</div>';
                        }
                        // Event details
...
<!-- Approved events -->
<div class="py-5" style="background-color: #0c77f1;">
    <div class="container">
        <h2>
        ...
        <hr style="border: none; height: 4px; background-color: #185fee;">
...
<!-- Pending Events -->
<div class="py-5" style="background-color: #2168f5">
    <div class="container">
        <h2>
...
<!-- Archive Section -->
<div class="py-5" style="background-color: #2d88f0;">
    <div class="container">
    <h2>
