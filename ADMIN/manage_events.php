                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($event['event_image'])): ?>
                                    <img src="<?= htmlspecialchars($event['event_image'], ENT_QUOTES, 'UTF-8') ?>" alt="Event Image" class="img-thumbnail" style="width: 70px; height: 50px; object-fit: cover;">
                                <?php else: ?>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                if ($eventDetails !== false) {
                                                    ...
                                                    <?php if (!empty($eventDetails['event_image'])): ?>
                                                        <p>Event Image:</p>
                                                        <img src="<?= htmlspecialchars($eventDetails['event_image'], ENT_QUOTES, 'UTF-8') ?>" alt="Event Image" class="img-fluid rounded" style="max-height: 250px; width: 100%; object-fit: cover;">
                                                    <?php else: ?>
                                                        <p>Event Image: No image</p>
                                                    <?php endif; ?>
                                                    <?php
                                                } else {
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <?php if (!empty($event['event_image'])): ?>
                                                            ...
                                                            <img src="<?= htmlspecialchars($event['event_image'], ENT_QUOTES, 'UTF-8') ?>" alt="Event Image" class="img-fluid rounded mb-2" style="max-height: 250px; width: 100%; object-fit: cover;">
                                                        <?php else: ?>
                                                            <p><strong>Event Image:</strong> No image</p>
                                                        <?php endif; ?>
