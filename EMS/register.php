...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6 mx-auto text-center">
            ...
            <a href="../index.php"><img src="../ASSETS/IMG/EMS_Icons/EMS_Icon.png?v=<?php echo time(); ?>" width="150" height="150" alt="EMS"  class="img-fluid mb-3"></a>
                ...
                <div class="register-footer">
                    ...
                    <p>Developed by <a href="https://github.com/sajib91/Event-Mangement-of-Cultural-Activities" target="_blank">Event-Mangement-of-Cultural-Activities
</a></p>
                </div>
            </div>
        </div>
