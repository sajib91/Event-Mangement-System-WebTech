        ...
        try {
            ...
            if (isset($_GET['event_id'])) {
                ...
                if ($eventDetails) {
                    ...
                    if (!empty($eventDetails['event_image'])) {
                        echo '<div class="mb-3">';
                        echo '<h6><strong>Event Image:</strong></h6>';
                        echo '<img src="' . htmlspecialchars($eventDetails['event_image'], ENT_QUOTES, 'UTF-8') . '" alt="Event Image" class="img-fluid rounded" style="max-height: 400px; width: 100%; object-fit: cover;">';
                        echo '</div>';
                        echo '<hr class="custom-separator">';
                    }
