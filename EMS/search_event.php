                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <?php if (!empty($event['event_image'])): ?>
                                            <div class="mb-3">
                                                <img src="<?php echo htmlspecialchars($event['event_image'], ENT_QUOTES, 'UTF-8'); ?>" alt="Event Image" class="img-fluid rounded" style="max-height: 250px; width: 100%; object-fit: cover;">
                                            </div>
                                        <?php endif; ?>
                                    <!-- Event details -->
